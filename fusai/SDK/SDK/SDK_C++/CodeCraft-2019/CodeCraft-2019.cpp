...
/* 构建基本数据结构 图、表、答案表 */
    ...
    //  status
    std::vector<std::vector<int>> staTable (TARDIS_default_volum, std::vector<int>(table.width(), 0));
    //print(staTable);
//    std::cout << table.width() << std::endl;
//    std::cout <<  isINF(0,1,5,&table,staTable) << std::endl;
//    INFThis(0,1,5,&table,staTable);
//    INFThis(0,1,6,&table,staTable);
//    INFThis(0,1,7,&table,staTable);
//    std::cout <<  isINF(0,1,5,&table,staTable) << std::endl;
//    std::cout <<  findSpace(0,1,5,&table,staTable) << std::endl;
